...
## Snapshot
- **Company:** Rosewood Hotels & Resorts (rosewoodhotels.com) — ultra-luxury hotel brand (part of Rosewood Hotel Group), in a 2025-26 brand refresh built on "Discovery" and experiences.
...
## Their use case
Local-events layer for content/storytelling + concierge, localized to US properties (Dallas/Santa Fe, Northern California). Tasteful examples, plain integration line, no AI clause.

## Their language
Brand refresh built on "Discovery."

## Next move
Send localized drafted emails to the US-property contacts Tracy Fitz (Dallas/Santa Fe), James Tattersall (Northern California), and Elie Kik (Americas region). HOLD Ashley Smith (unverifiable / Caribbean property); treat Mary Barnes as lower priority (global/HK role, US-only caveat).
