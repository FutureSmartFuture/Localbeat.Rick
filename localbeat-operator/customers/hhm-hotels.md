...
## Snapshot
- **Company:** HHM Hotels (hhmhotels.com) — large US third-party hotel management company (formerly tied to Hersha); in 2026 integrated Wurzak Hotel Group and launched the Echelon Luxury & Lifestyle division. Operates hotels for owners across scales.
...
## Their use case
The manager retargeting + guest-experience play, framed as "the tool stack you offer your properties" and closing "adds value for HHM and its properties." Plain integration line (operator, not an AI builder).

## Next move
Send the drafted email to James Meminger (SVP eCommerce) as the digital target, plus Natalie Mesa-Martinez and Cole Hernandez. Verify Jack Vielhauer's employer and Stacey Evans before sending.
