...
## Snapshot
- **Company:** Expedia Group (expediagroup.com) — global OTA/travel platform. 2026 direction (Explore 2026): AI as the growth engine (AI travel experiences, AI trip planning, a B2B AI toolkit for distribution), plus the "connected trip," attractions, and Media Solutions (its advertising business, "Cornerstone").
...
## Their use case
Emails clustered by role: Strategic Partnerships & Affiliates = data partnership feeding discovery, the trip planner, and ad products; Hotel Market Partnerships = event-driven demand for hotel partners; Tech/Product (CTO, Tech Partnerships, Media Solutions ad lead) = platform + ads + the AI-assistant clause; Finance/Analytics = a clean event-demand input; Chief of Staff = strategy/routing.

## Next move
Send the drafted emails by cluster (partnerships, hotel market, tech/product incl. Media Solutions, finance, chief of staff). HOLD Darek Blasey (unverifiable); treat Brett Dilley as a router; note Ashley Schwartz's title appears inflated.
