...
## Snapshot
- **Company:** Sonesta International Hotels (sonesta.com) — large US multi-brand hotel company (owns/operates + franchises; brands incl. Sonesta, Royal Sonesta, Red Lion), with strong franchise growth (22 openings H1 2026; co-CEOs Keith Pierce & Jeff Leer, Apr 2026).
...
## Their use case
Corporate marketers get the "offer-your-properties" framing (Chris Trick with demand-gen/performance + retargeting; Amanda Marcello, franchise marketing); property DOSMs get the standard version. Plain integration line, no AI clause.

## Next move
Send the drafted emails to Chris Trick (CMO, offer-your-properties + performance) and Amanda Marcello (VP, franchise marketing), plus property DOSM Thomas Graffeo. Verify Michele Simpson's identity (wrong LinkedIn on sheet); remove Charleen Murphy (departed to Airbnb).
