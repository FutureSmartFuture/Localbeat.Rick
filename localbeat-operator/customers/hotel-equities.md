...
## Snapshot
- **Company:** Hotel Equities (hotelequities.com) — hotel management company that merged with Springboard Hospitality (adding a lifestyle/independent division). Operates hotels for owners.
...
## Their use case
The manager retargeting + guest-experience play, framed as "the tool stack you offer your properties," closing "adds value for Hotel Equities and its properties." Plain integration line. Eve Tronson gets a lifestyle-flavored version (Springboard division).

## Next move
Send the drafted email to Lisa Tully-Lavian (EVP, senior target), Dana Wendell, and Eve Tronson (lifestyle version). Find Stacey Gauthier's current @hotelequities.com address before sending (the lagunacliffs.com email is stale); confirm Kelly Keith.
