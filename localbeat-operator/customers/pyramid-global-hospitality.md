...
## Snapshot
- **Company:** Pyramid Global Hospitality (pyramidglobal.com; formerly Benchmark Pyramid) — large US hotel management company with a Luxury & Lifestyle division (Benchmark). Operates hotels/resorts for owners.
...
## Their use case
The manager retargeting + guest-experience play, framed as "the tool stack you offer your properties," closing "adds value for Pyramid Global and its properties." Plain integration line.

## Next move
Send the drafted emails to Brittany Farella, Jenna Keegan, Skip James (resort lean), and Fred DeSota (luxury/lifestyle lean). Confirm Simon Rendall's current email (legacy @pyramidhotelgroup.com) before sending to the digital/retargeting target.
