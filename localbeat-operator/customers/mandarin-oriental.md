...
## Snapshot
- **Company:** Mandarin Oriental Hotel Group (MOHG, mohg.com) — luxury hotel group. The sheet's contact list is largely stale.
...
## Their use case
Local-events layer for content/comms + guest experience (Danielle) and commercial strategy / retargeting + demand-gen (Jeanne). Tasteful luxury examples, plain integration line, no AI clause.

## Next move
Send the drafted cold-open emails to Danielle McNally (Boston, content/concierge) and Jeanne Delgado (NYC, commercial strategy). HOLD Angela Caicedo (wrong title) and Rosalynn Castillo (Caribbean, outside coverage); remove Kylee Kozisek (departed).
