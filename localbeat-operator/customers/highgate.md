...
## Snapshot
- **Company:** Highgate (highgate.com) — large hotel management/operating company, expanding its award-winning luxury-lifestyle portfolio (Kessler Collection division, Lotte partnership across the Americas/Asia). Operates hotels for owners.
...
## Their use case
The manager retargeting + guest-experience play, framed as "the tool stack you offer your properties" and closing "adds value for Highgate and its properties." Plain integration line (operator, not an AI builder).

## Next move
Send the drafted email to Brian Winston (EVP) as the senior target, plus Dayna Zeitlin, Ryan Eddy, and Matt Tobin. Verify Kevin Bryant (E11EVEN posts; his Caribbean/LatAm region is outside US coverage, though Florida is covered).
