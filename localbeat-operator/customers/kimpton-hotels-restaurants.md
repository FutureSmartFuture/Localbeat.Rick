...
## Snapshot
- **Company:** Kimpton Hotels & Restaurants (kimptonhotels.com) — lifestyle hotel brand under IHG, known for local character. Contacts are mostly property-level.
...
## Their use case
LocalBeat as a live local-events layer for each property's marketing, web, guest experience, and (for the digital lead) retargeting; property emails localized to Seattle/Nashville/Chicago. No "offer your properties" manager framing. Plain integration line, no AI clause.

## Next move
Send the drafted HQ email to Brent Oswald and localized property emails to Anna Hughes (Seattle), Lindsey Sullivan (Nashville), and Lucas Lopresti (Chicago). HOLD Haroon Chaudhry (likely departed to Highgate).
