...
## Snapshot
- **Company:** Airbnb — global short-term-stay booking platform (not a property manager); 2026 "super-app" push: expanded Experiences (3,000+ Landmarks, 2,500+ Food Culture, FIFA World Cup 2026 across 6 host cities), new Services (grocery, airport pickup, luggage, car rental), AI trip planning, and boutique/independent hotels in 20 destinations.
...
## Their use case
Feed 85M+ events / 300K+ venues into (1) Experiences and "things to do near your stay" discovery, (2) AI itinerary/trip planning, and (3) ad retargeting that pulls abandoned stay-searchers back with event-tied ads. Framed as a data layer inside Airbnb's own products, not resold to owners.

## Their language
"Airbnb more than an Airbnb" (super-app direction); AI itineraries mapping "restaurants, experiences, and things to do" near a stay.

## Next move
Send the drafted outreach to Lou Zameryka and Alston Cheek (best-fit); use Daniel Skold as a router if needed; verify Sam Kline and Raoul Arboite before sending. The Yuzhi Zhang "CTO" row was dropped as an erroneous scraped record (real CTO is Ahmad Al-Dahle).
